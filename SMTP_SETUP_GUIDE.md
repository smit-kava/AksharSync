...
1. **Go to your Google Account Settings**:
   - Visit [Google Account Security](https://myaccount.google.com/security) and log in with your account: `xxxx@gmail.com`.
...
### 2. For Production Server (`../api/send-email.php`)

Open `../api/send-email.php` (which runs on your CWP Server):
...
### 3. For Production Connection Tester (`../api/test-connection.php`)

Open `../api/test-connection.php` (optional but recommended for debugging):
...
2. **Upload the files**:
   ...
   - Make sure your updated `api/send-email.php` and `../test-connection.php` are under your domain's `/api/` path.
...
3. If it returns **"Connection Test Successful"**, your Google SMTP server is successfully authenticating and sending emails to `xxx@gmail.com`!
